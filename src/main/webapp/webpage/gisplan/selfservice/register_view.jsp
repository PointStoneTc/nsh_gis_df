...
<script type="text/javascript" src="${webRoot}/static/js/gisplan/selfservice/register_view.js"></script>
...
<body style="width: 98%;">
	<form name="formobj" id="formobj" method="post" action="register.do?saveOrUpdate">
		<input type="text" name="selfservice.id" value="${view.selfservice.id }" /> <input type="text" name="selfservice.type" value="${view.selfservice.type }" /> <input type="hidden"
			name="sg.id" value="${view.sg.id }" />
		<!-- 自助设备详情 -->
		<div>
			...
			<table style="width: 100%;" cellpadding="0" cellspacing="1" class="viewtable">
				<tbody>
					<tr>
						...
						<td><input type="text" name="selfservice.code" value="${view.selfservice.code }" maxlength="10" /></td>
						<th><label class="required_sign">名称</label></th>
						<td><input type="text" name="selfservice.name" value="${view.selfservice.name }" datatype="*" sucmsg="名称验证通过!" nullmsg="请输入名称!" maxlength="30" /></td>
					</tr>
					<tr>
						<th><label class="required_sign">设备类型</label></th>
						<td><select name="selfservice.typeCode" id="typeCode" datatype="*" nullmsg="请选择设备类型!">
						...
						<td><select name="selfservice.dotId" id="dotId" datatype="*" nullmsg="请选择所属支行!">
								<option value="" selected="selected">---请选择---</option>
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="selfservice.address" value="${view.selfservice.address }" maxlength="50" style="width: 440px" /></td>
					</tr>
					<tr>
