...
<script type="text/javascript" src="${webRoot}/static/js/gisplan/product/merchantSelectOneOrMult_dialog.js"></script>
<link rel="stylesheet" href="${webRoot}/static/style/css/commcon.css">
</head>
<body>
	<table id="productList" class="easyui-datagrid"
		data-options="rownumbers:true,singleSelect:${singleSelect},fit:true,url:'select.do?oneOrMultDatagrid&merchantId=${merchantId}&excludeIds=${excludeIds}&field=id,dotName,business,name,isEffect,effectDate,invalidDate',method:'post'">
		<thead>
			<tr>
				<th data-options="field:'id',hidden:true">id</th>
				<th data-options="field:'dotName',align:'center'">所属银行</th>
