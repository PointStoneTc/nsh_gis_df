...
<script type="text/javascript"
	src="${webRoot}/static/js/gisplan/product/register_view.js"></script>
...
<body style="width: 90%;">
	<form name="formobj" id="formobj" method="post"
		...
		<!-- 借款信息 -->
		<div>
			<input type="hidden" name="id" id="id" value="${view.id }" /> <input
				type="hidden" name="business" value="${view.business }" />
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="name" value="${view.name }"
							datatype="s1-10" sucmsg="名称验证通过!" nullmsg="请输入名称!" maxlength="10" /></td>
					</tr>
					<tr>
						<th><label>是否生效</label></th>
						<td><input type="radio" value="0" name="isEffect"
							id="isEffect_y">否<input type="radio" value="1"
							name="isEffect" checked="checked">是</td>
					</tr>
					<tr>
						<th><label>生效时间</label></th>
						<td><input type="text" class="Wdate"
							onClick="WdatePicker({isShowClear:false,readOnly:true})"
							name="effectDate" id="effectDate" value="${view.effectDate }"
							datatype="*" ignore="ignore" sucmsg="生效时间验证通过!" /></td>
					</tr>
					<tr>
						<th><label>失效时间</label></th>
						<td><input type="text" class="Wdate"
							onClick="WdatePicker({isShowClear:false,readOnly:true})"
							name="invalidDate" id="invalidDate" value="${view.invalidDate }"
