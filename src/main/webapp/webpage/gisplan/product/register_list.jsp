...
<script type="text/javascript"
	src="${webRoot}/static/js/gisplan/product/register_list.js"></script>
	...
	<table id="registerList" name="registerList" class="easyui-datagrid"
		...
		<thead>
			<tr>
				...
				<th
					data-options="field:'isCommit',align:'center',formatter:formatRw">是否提交</th>
				<th
		...
		<table>
			<tr>
				<td><a id="add" href="#" class="easyui-linkbutton"
					data-options="iconCls:'icon-add'" onclick="addProduct()">新增</a></td>
