...
<script type="text/javascript"
	src="${webRoot}/static/js/gisplan/dot/register_list.js"></script>
			...
			<table>
				<tr class="queryToolbarTable">
					<td><a id="add" href="#" class="easyui-linkbutton"
						data-options="iconCls:'icon-add'" onclick="addDot()">新增</a></td>
					<td class="borderRight"><a id="view" href="#"
						class="easyui-linkbutton" data-options="iconCls:'icon-tip'"
						onclick="detailDot()">查看详情</a></td>
					...
					<td class="borderLeft"><a id="search" href="#"
