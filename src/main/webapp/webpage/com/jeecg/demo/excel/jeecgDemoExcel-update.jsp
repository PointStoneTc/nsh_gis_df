...
<style>
.col-xs-3>input, .col-xs-3>select {
	width: 100%
}
</style>
<script type="text/javascript">
...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="jeecgDemoExcelController.do?doUpdate"
		tiptype="1">

		<input type="hidden" id="btn_sub" class="btn_sub" />
		<input type="hidden" name="id" value='${jeecgDemoExcelPage.id}'>
		<div class="tab-wrapper">
			<!-- tab -->
			<ul class="nav nav-tabs">
				<li role="presentation" class="active"><a
					href="javascript:void(0);">excel导入导出测试表</a></li>
			</ul>
			...
			<div class="con-wrapper" id="con-wrapper1" style="display: block;">
				<div class="row form-wrapper">
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="name" name="name" maxlength="100" type="text"
								class="form-control" ignore="ignore"
								value='${jeecgDemoExcelPage.name}' /> <span
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="sex" type="list"
								extendJson="{class:'form-control'}" typeGroupCode="sex"
								defaultVal="${jeecgDemoExcelPage.sex}" hasLabel="false"
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="birthday" name="birthday" type="text"
								...
								value='<fmt:formatDate value='${jeecgDemoExcelPage.birthday}' type="date" pattern="yyyy-MM-dd"/>' />
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
								class="Validform_label" style="display: none">生日</label>
						</div>
					</div>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="depart" type="list"
								extendJson="{class:'form-control'}" dictTable="t_s_depart"
								dictField="id" dictText="departname"
								defaultVal="${jeecgDemoExcelPage.depart}" hasLabel="false"
								title="关联部门"></t:dictSelect>
							<span class="Validform_checktip"
								style="float: left; height: 0px;"></span> <label
								class="Validform_label" style="display: none">关联部门</label>
						</div>
					</div>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="fdReplace" name="fdReplace" maxlength="255"
								type="text" class="form-control" ignore="ignore"
								value='${jeecgDemoExcelPage.fdReplace}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="fdConvert" name="fdConvert" maxlength="255"
								type="text" class="form-control" ignore="ignore"
								value='${jeecgDemoExcelPage.fdConvert}' /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
