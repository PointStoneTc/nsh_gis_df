...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password"
		layout="table" action="jeecgDemoExcelController.do?doAdd" tiptype="1">
			...
			<div class="con-wrapper" id="con-wrapper1" style="display: block;">
				<div class="row form-wrapper">
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="birthday" name="birthday" type="text" ignore="ignore"
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="depart" type="list"
								...
								dictField="id" dictText="departname" hasLabel="false"
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="fdReplace" name="fdReplace" maxlength="255"
								type="text" class="form-control" ignore="ignore" /> <span
								class="Validform_checktip" style="float: left; height: 0px;"></span>
