...
public class BaseTag extends JeecgTag {
    ...
    public StringBuffer end() {
        ...
        if (oConvertUtils.isIn("easyui", types)) {
            ...
            sb.append("<script type=\"text/javascript\" src=\"" + basePath + "/plug-in/easyui/jquery.easyui.min.js\"></script>");
        ...
        if (oConvertUtils.isIn("validform", types)) {
            ...
            sb.append("<script type=\"text/javascript\" src=\"" + basePath + "/plug-in/Validform/js/tiptype.js\"></script>");
            sb.append("<link rel=\"stylesheet\" href=\"" + basePath + "/plug-in/Validform/css/tiptype.css\" type=\"text/css\"></link>");
        }
        ...
        if (oConvertUtils.isIn("bdmap", types)) {
            sb.append("<script type=\"text/javascript\" src=\"http://api.map.baidu.com/api?v=2.0&ak=" + ResourceUtil.getConfigByName("bdmap_client_key") + "\"></script>");
            sb.append("<script type=\"text/javascript\" src=\"" + basePath + "/static/js/gisplan/bdmap.js\"></script>");
        }
    ...
    public String toString() {
        String basePath = ResourceUtil.getBasePath();
        return new StringBuffer().append("BaseTag [type=").append(type).append(",sysTheme=").append(SysThemesUtil.getSysTheme(ContextHolderUtils.getRequest()).getStyle())
                .append(",brower_type=").append(ContextHolderUtils.getSession().getAttribute("brower_type")).append(",cssTheme=").append(cssTheme).append(",basePath=")
                .append(basePath).append("]").toString();
    }
